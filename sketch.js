...
var ball;
var pinkballImg, yellowballImg, greenballImg, blueballImg, purpleballImg, gameOverImg;
var pinkball, yellowball, greenball, blueball, purpleball, gameOver;
...
fill("black");
text("Trys Left: " + trial, 150, 100);
text("Retrieve Ball", width/1, height/6);
Engine.update(engine);
}

function retrieveBall(){
ball.x = 100;
ball.y = 270;
ball.velocityX = 0;
trial = trial - 1;
